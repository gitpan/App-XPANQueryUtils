...
App::XPANQueryUtils - XPAN::Query command-line utilities

=head1 VERSION

This document describes version 0.02 of App::XPANQueryUtils (from Perl distribution App-XPANQueryUtils), released on 2014-07-02.
